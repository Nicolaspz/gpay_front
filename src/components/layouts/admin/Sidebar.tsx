...
const menuItems = [
  ...
  { icon: CreditCard, label: "Stripe", href: "/dashboard/stripe", enabled: true },
  { icon: FileText, label: "Membros", href: "/dashboard/members", enabled: false },
  { icon: Book, label: "Transação", href: "/dashboard/transactions", enabled: true },
  { icon: Folder, label: "Relatórios", href: "/dashboard/relatory", enabled: false },
  ...
  return (
    ...
    <Link href="/" className="flex items-center justify-center w-full h-full">
      ...
      />
        ...
        {menuItems.map(({ icon: Icon, label, href, enabled }) => {
