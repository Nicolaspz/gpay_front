      ...
      <div className="bg-gray-50 dark:bg-gray-800 p-4 rounded-xl flex flex-wrap items-end gap-4 border border-gray-100 dark:border-gray-700">
        <div>
          ...
          <input
            ...
            className="bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-md px-3 py-2 text-sm outline-none"
          />
        </div>
        <div>
        ...
        {isAdmin && (
          <div className="flex items-center gap-2 pb-2 ml-4">
            ...
            />
            <label htmlFor="groupCheck" className="text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
              Agrupar por Empresa
            </label>
          </div>
        )}
        <button
          ...
          className="bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-xs px-3 py-2 rounded-md font-medium"
        >
          Limpar
        </button>
      </div>
