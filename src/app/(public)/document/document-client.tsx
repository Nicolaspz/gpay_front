...
export default function GPaymentDocumentationClient() {
      ...
      {mobileSidebarOpen && (
        ...
        >
          ...
          >
            ...
            <nav className="flex-1 overflow-y-auto p-3 space-y-1" aria-label="Navegação da documentação">
              {navigation.map((item) => {
        ...
        <div className="flex gap-8">
          ...
          <aside className="hidden lg:block w-64 flex-shrink-0">
            <div className="sticky top-6 space-y-6">
              ...
              <nav className="space-y-2" aria-label="Navegação lateral da documentação">
                {navigation.map((item) => {
                  const Icon = item.icon
                  return (
                    <button
